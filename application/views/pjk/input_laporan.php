      ...
      <div class="main_container">
       ...
       <?php echo validation_errors(); ?>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <?php 
           $data = array('name' => 'bukti_biaya', 'id' => 'dokumentasi', 'class' => 'form-control', 'placeholder' => 'Upload Dokumentasi');
           echo form_textarea($data); ?>
          </div>
        </div>
        ...
        <div class="form-group">
        <div class="col-sm-10">
          <label for="file1" class="col-sm-2 control-label">Dokumentasi</label>
        ...
        <div class="form-group">
        <div class="col-sm-10">
          <label for="file2" class="col-sm-2 control-label">Dokumentasi</label>
