    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <h1 class="text-center text-info">Edit Aktif Kuliah</h1> <br />
          <?php foreach($data_aktif_kuliah as $kuliah) { ?>
       <?php echo form_open('simft/aktif_kuliah/edit_proses/'.$kuliah->id_aktif_kuliah,array('id' => 'tambah','name' => 'tambah', 'class' => 'form-horizontal')); ?>
       ...
       <p class="text-danger" style="font-size:20px;"><?php echo $this->session->flashdata('pesan'); ?></p>
        ...
        <div class="form-group">
         ...
         <div class="col-sm-6">
            <select class="form-control" name="jenis" >
                <option value="aktif_kuliah">Formulir Aktif Kuliah</option>
            </select>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <?php 
           $data = array('name' => 'nama', 'id' => 'nama', 'class' => 'form-control', 'placeholder' => 'Nama','value' => $kuliah->nama);
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <?php 
           $data = array('name' => 'nim', 'id' => 'nim', 'class' => 'form-control', 'placeholder' => 'NIM','value' => $kuliah->nim);
           echo form_input($data); ?>
          </div>
        </div>
         ...
         <div class="col-sm-6">
            <select class="form-control" name="id_jurusan" >
                 <option value="">-- Pilih Jurusan --</option>
                  ...
                  <?php if($jurusan->id_jurusan == $kuliah->id_jurusan) { ?>
         ...
         <div class="col-sm-6">
            <select class="form-control" name="id_prodi" >
                 <option value="">-- Pilih Prodi --</option>
                  ...
                  <?php if($prodi->id_prodi == $kuliah->id_prodi) { ?>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <?php 
           $data = array('name' => 'nope', 'id' => 'nope', 'class' => 'form-control', 'placeholder' => 'No. HP','value' => $kuliah->nope);
           echo form_input($data); ?>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <?php 
           $data = array('name' => 'nama_ortu', 'id' => 'nama_ortu', 'class' => 'form-control', 'placeholder' => 'Nama Orang Tua','value' => $kuliah->nama_ortu);
           echo form_input($data); ?>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <?php 
           $data = array('name' => 'nip', 'id' => 'nip', 'class' => 'form-control', 'placeholder' => 'NIP/NRP/NoPeg','value' => $kuliah->nip);
           echo form_input($data); ?>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <?php 
           $data = array('name' => 'pangkat_golru', 'id' => 'pangkat_golru', 'class' => 'form-control', 'placeholder' => 'Pangkat / Golru','value' => $kuliah->pangkat_golru);
           echo form_input($data); ?>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <?php 
           $data = array('name' => 'instansi_kantor', 'id' => 'instansi_kantor', 'class' => 'form-control', 'placeholder' => 'Instansi/Kantor','value' => $kuliah->instansi_kantor);
           echo form_input($data); ?>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <?php 
           $data = array('name' => 'keperluan', 'id' => 'keperluan', 'class' => 'form-control', 'placeholder' => 'Guna Keperluan','value' => $kuliah->keperluan);
           echo form_input($data); ?>
          </div>
        </div>
